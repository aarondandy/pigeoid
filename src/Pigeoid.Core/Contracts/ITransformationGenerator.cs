...
namespace Pigeoid.Contracts
{
	...
	[Obsolete]
	public interface ITransformationGenerator<in TItem,TValueFrom,TValueTo> : ITransformationGenerator<TItem>
	{
		new ITransformation<TValueFrom, TValueTo> Generate(TItem from, TItem to);
	}
