...
namespace Pigeoid
{
	...
	public class BasicCoordinateOperationToTransformationGenerator2 : ICoordinateOperationCompiler
	{
		...
		private class OperationGenerationParams
		{
			...
			public ICrs CrsFrom;
			public ICrs CrsTo;
			public UnitData UnitsFrom;
			public UnitData UnitsTo;
		}

		private class UnitData
		{
			public readonly IUnit HorizontalLinearUnit;
			public readonly IUnit VerticalLinearUnit;
			public readonly IUnit AngularUnit;
		}
		...
		public BasicCoordinateOperationToTransformationGenerator2(){
