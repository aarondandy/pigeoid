...
namespace Pigeoid.Projection
{
	public abstract class HotineObliqueMercator : ProjectionBase
	{
		...
		public class VariantA : HotineObliqueMercator
		{
			...
			public VariantA(GeographicCoordinate geographicCenter, double azimuthOfInitialLine, double angleFromRectified, double scaleFactor, Vector2 falseProjectedOffset, [NotNull] ISpheroid<double> spheroid)
		...
		public class VariantB : HotineObliqueMercator
		{
			...
			public VariantB(GeographicCoordinate geographicCenter, double azimuthOfInitialLine, double angleFromRectified, double scaleFactor, Vector2 falseProjectedOffset, [NotNull] ISpheroid<double> spheroid)
				: base(geographicCenter, azimuthOfInitialLine, angleFromRectified, scaleFactor, falseProjectedOffset, spheroid) { }
		...
		protected HotineObliqueMercator(GeographicCoordinate geographicCenter, double azimuthOfInitialLine, double angleFromRectified, double scaleFactor, Vector2 falseProjectedOffset, [NotNull] ISpheroid<double> spheroid)
